...
window.onload = function init()
{
	...
	a.addEventListener ("click", function() { axis = xAxis; rot = 1.0;});
	var b=document.getElementById ("YButton");
	b.addEventListener ("click", function () { axis = yAxis; rot = 1.0;});
	var c=document.getElementById ("ZButton");
	c.addEventListener ("click", function () { axis = zAxis; rot = 1.0;});
	var d=document.getElementById ("Reset");
	d.addEventListener ("click", function () { theta = [0.0, 0.0, 0.0]; axis = xAxis; rot=1.0; });
	var stop=document.getElementById ("Stop");
	stop.addEventListener ("click", function () { rot = 0;});
